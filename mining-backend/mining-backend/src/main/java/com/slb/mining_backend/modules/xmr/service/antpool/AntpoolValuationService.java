...
@Service
public class AntpoolValuationService {
    ...
    public AntpoolValuationService(ExchangeRateService exchangeRateService,
                                   MarketDataService marketDataService,
                                   AntpoolProperties properties) {
    ...
    public RateSnapshot resolveRate(String coin) {
        ...
        AntpoolProperties.Valuation valuation = properties.getValuation();
        BigDecimal manual = valuation != null ? valuation.getManualCoinToCal() : null;
    ...
    private String resolveCoinToCnySymbol(String coin) {
        AntpoolProperties.Valuation valuation = properties.getValuation();
        if (valuation != null && StringUtils.hasText(valuation.getCoinToCnySymbol())) {
            String override = valuation.getCoinToCnySymbol();
    ...
    private String resolveCoinToXmrSymbol(String coin) {
        AntpoolProperties.Valuation valuation = properties.getValuation();
        if (valuation != null && StringUtils.hasText(valuation.getCoinToXmrSymbol())) {
            String override = valuation.getCoinToXmrSymbol();
            if (matchesCoinSymbol(coin, override)) {
                return override;
            }
        }
